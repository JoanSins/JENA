		...
		if($row['numrows'] > 0){
			if($row['status']){
				$output .= '
		            ...
		            <h4><a href="login.php">Iniciar sesión</a> o de vuelta a <a href="index.php">Página principal</a>.</h4>
				';
			}
			else{
				try{
					...
					$output .= '
			            ...
			            </div>Iniciar sesión</a> o de vuelta a la<a href="index.php">Página principal</a>.</h4>
					';
				}
