		...
		if($row['numrows'] > 0){
			...
			try{
				...
				$message = "
					...
					<a href='http://localhost/tienda_online/password_reset.php?code=".$code."&user=".$row['id']."'>Restablecer la contraseña</a>
				";
			    ...
			    try {
			        ...
			        //Content
			        $mail->isHTML(true);                                  
			        $mail->Subject = 'Restablecimiento de Contraseña del Sitio JENA';
			        $mail->Body    = $message;
